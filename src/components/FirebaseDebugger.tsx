...
export class FirebaseDebugger extends Component<{}, State> {
  constructor(props: {}) {
    super(props);
  ...
  loadDebugInfo = async () => {
    this.setState(prevState => ({
      debugInfo: { ...prevState.debugInfo, loading: true }
    }));
