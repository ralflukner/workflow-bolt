...
# scripts/fix-consistency-checker-esm.sh

set -e

echo "🔧 Fixing the consistency checker with ES modules..."
echo "=================================================="
echo ""

# Create a proper ES module version
cat > scripts/check-env-gsm-consistency-fixed.js << 'JS_EOF'
#!/usr/bin/env node
...
chmod +x scripts/check-env-gsm-consistency-fixed.js

echo "🧪 Testing the fixed version..."
node scripts/check-env-gsm-consistency-fixed.js

echo ""
echo "💡 If it works, let's replace the original:"
echo "   mv scripts/check-env-gsm-consistency-fixed.js scripts/check-env-gsm-consistency.js"